...
const Header = () => {
  return (
    <header className="glass sticky top-0 z-[60] bg-[#F5F2EC]/70 backdrop-blur-md after:pointer-events-none after:absolute after:left-0 after:right-0 after:top-full after:h-6 after:bg-gradient-to-b after:from-[#F5F2EC]/70 after:to-transparent dark:bg-night-950/70 dark:after:from-night-950/70">
